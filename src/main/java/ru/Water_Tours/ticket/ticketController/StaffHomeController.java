...
public class StaffHomeController {
    ...
    public String page(Authentication authentication, HttpServletRequest request) {
        ...
        sb.append("<h2><a href=\"/staff/order-support\">Поддержка заказа</a></h2>");
        sb.append("<p>Найти заказ по точному номеру, email или телефону и увидеть всё, что нужно для разговора с клиентом: ")
                .append("оплату, выпуск билетов, состояние письма и статусы билетов. Там же — исправление адреса доставки, ")
                .append("если клиент ошибся в почте: отправляется уже выпущенный билет, деньги и билет не затрагиваются. ")
                .append("Имя покупателя система не хранит.</p>");

        sb.append("<h2><a href=\"/staff/support-inquiries\">Вопросы клиентов</a></h2>");
        sb.append("<p>Только просмотр последних обращений с сайта и из бота. Нужна на случай, когда Telegram не принял ")
                .append("уведомление владельцу: такое обращение видно здесь со статусом «не доставлено». ")
                .append("Отвечает владелец в Telegram командой /reply, на вопросы с сайта — вручную по контакту клиента.</p>");
