...
<meta name="description" content="Петербург с воды: билеты на речную прогулку и аренда катера для своей компании. Электронный билет с QR-кодом действует 72 часа после оплаты.">
...
<img class="hero-photo" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/hero-canal.jpg" alt="Канал и вечерний Петербург" width="1400" height="936" fetchpriority="high">
