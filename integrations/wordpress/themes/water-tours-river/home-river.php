...
</main><footer class="site-footer wrap"><a class="brand" href="#top"><span class="brand-mark" aria-hidden="true">≈</span>water tours</a><p>Речные прогулки в Петербурге</p><div class="footer-contacts"><p class="footer-boarding"><?php echo esc_html(wt_river_contact_city()); ?>. Посадка: <?php echo esc_html(wt_river_contact_boarding()); ?>.</p><?php $wt_river_tg = wt_river_contact_telegram_url(); if ($wt_river_tg !== '') : ?><a class="btn btn-ask footer-telegram" href="<?php echo esc_url($wt_river_tg); ?>" target="_blank" rel="noopener noreferrer">Написать в Telegram <span aria-hidden="true">↗</span></a><?php endif; ?></div><a href="<?php echo esc_url(home_url('/contacts/')); ?>">Контакты</a><a href="#faq">Правила билета</a></footer>
